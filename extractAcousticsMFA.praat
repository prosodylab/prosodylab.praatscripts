...
form Calculate Results for Production Experiments
	...
	sentence Output_Filename simpleRC2
	sentence extension .wav
	# Specify directory -- otherwise selected soundfiles will be annotated
	sentence Sound_directory ../3_annotate/truncated
   	...
   	mySound=selected()
		...
		zlabel$=""
			...
			if label$ <> ""  
				...
				phoneinterval = Get interval at time... 'phonTier' 'wordonset'
				phonelast = Get interval at time... 'phonTier' 'wordoffset'
