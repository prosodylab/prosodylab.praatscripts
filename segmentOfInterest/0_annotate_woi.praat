...
form Annotate Words of Interest	
	sentence Woi_file ../../1_experiment/rogerDan.txt
...
for i to numberOfLoops
	...
	call getWoiLine
		...
		intCounter = 0
			...
			if label$ <> word$
				printline Unmatched word in labfile: 'label$' woilineword: 'word$'
			elsif woiFound=1
...
#system grep -w woi$ -m 1 dictionary_file$