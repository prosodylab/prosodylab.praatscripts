...
form Calculate Results for Production Experiments
	...
	sentence Result_filename ersapro9
...
output$ = return$ + "word" +  "'seperator$'"  + "wordlabel" + "'seperator$'" + "segment" +  "'seperator$'"
		   ... + "precedingSegment" +  "'seperator$'" + "followingSegment" +  "'seperator$'"
		    ...+ "phonelength"
 			...
 			...+  "'seperator$'" + "firstF1Male" + "'seperator$'" + "firstF2Male" + "'seperator$'" + "firstdifMale"
		     ...+  "'seperator$'" + "secondF1Male" + "'seperator$'" + "secondF2Male" + "'seperator$'" + "seconddifMale"
		     ...+  "'seperator$'" + "thirdF1Male" + "'seperator$'" + "thirdF2Male" + "'seperator$'" + "thirddifMale"
		     ...+  "'seperator$'" + "fourthF1Male" + "'seperator$'" + "fourthF2Male" + "'seperator$'" + "fourthdifMale"
		     ...+  "'seperator$'" + "fifthF1Male" + "'seperator$'" + "fifthF2Male" + "'seperator$'" + "fifthdifMale"
                     ...+ newline$
...
# counter counts the silent intervals separating words
     ...
     for interval from 1 to numbInt
		...
		firstF1Male = Get value at time... 1 'wordonset' Hertz Linear
		firstF2Male = Get value at time... 2 'wordonset' Hertz Linear
		firstdifMale = firstF2Male - firstF1Male
		secondF1Male = Get value at time... 1 'first' Hertz Linear
		secondF2Male = Get value at time... 2 'first' Hertz Linear
		seconddifMale = secondF2Male - secondF1Male
		thirdF1Male = Get value at time... 1 'second' Hertz Linear
		thirdF2Male = Get value at time... 2 'second' Hertz Linear
		thirddifMale = thirdF2Male - thirdF1Male
		fourthF1Male = Get value at time... 1 'third' Hertz Linear
		fourthF2Male = Get value at time... 2 'third' Hertz Linear
		fourthdifMale = fourthF2Male - fourthF1Male
		fifthF1Male = Get value at time... 1 'wordoffset' Hertz Linear
		fifthF2Male = Get value at time... 2 'wordoffset' Hertz Linear
		fifthdifMale = fifthF2Male - fifthF1Male
		...
		return2$ = replace$(return$,  "'seperator$'","_",0)
	 	...
	 	output$ = return$  + "'label$'" + "'seperator$'" + "'wordlabel$'" + "'seperator$'" + "'segment$'" +  "'seperator$'"     
						...
						...+ "'seperator$'" + "'firstF1Male:3'" + "'seperator$'" + "'firstF2Male:3'" + "'seperator$'" + "'firstdifMale:3'"
						...+ "'seperator$'" + "'secondF1Male:3'" + "'seperator$'" + "'secondF2Male:3'" + "'seperator$'" + "'seconddifMale:3'"
						...+ "'seperator$'" + "'thirdF1Male:3'" + "'seperator$'" + "'thirdF2Male:3'" + "'seperator$'" + "'thirddifMale:3'"
						...+ "'seperator$'" + "'fourthF1Male:3'" + "'seperator$'" + "'fourthF2Male:3'" + "'seperator$'" + "'fourthdifMale:3'"
						...+ "'seperator$'" + "'fifthF1Male:3'" + "'seperator$'" + "'fifthF2Male:3'" + "'seperator$'" + "'fifthdifMale:3'"
						...+ newline$
